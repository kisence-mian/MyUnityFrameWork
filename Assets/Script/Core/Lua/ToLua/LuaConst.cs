...
{
    //public static string luaDir = Application.dataPath + "/Script/Core/Lua/";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Script/Core/Lua/ToLua";        //tolua lua文件目录
